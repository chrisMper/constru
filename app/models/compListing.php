...
// add new listing
    public function addlisting($data, $file)
    {
      ...
      // Prepare Query
      $this->db->query('INSERT INTO comp_listing (Title,Description,UserEmail,visiterCount,Photos	) 
...
//update listiing
    public function updatelisting($data, $file,$id)
    {
      ...
      $this->db->query('UPDATE comp_listing SET Title = :title, Description = :description, UserEmail = :Uemail WHERE PostId= :id' );
