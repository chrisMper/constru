...
class adminModel {
  ...
  public function getAdmins()
    ...
    public function addAdmin($data) {
      ...
      $this->db->query('INSERT INTO admins ( fname, lname, contact_number, email, nic, age, address, password) VALUES (:fname, :lname, :contact_number, :email, :nic, :age, :address, :password)');
      // Bind values
