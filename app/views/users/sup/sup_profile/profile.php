   ...
   <div class="profile">
    ...
    <div class="details">
        <div class="userdetails">
            ...
            Name : <?php echo $profile->fName; ?> <?php echo $profile->lName; ?><br><br>
            Email : <?php echo $profile->email; ?> <br><br>
            Address : <?php echo $profile->adLine1; ?>, <?php echo $profile->adLine2; ?>, <?php echo $profile->city; ?>, <?php echo $profile->district; ?> <br><br>
            Role : <?php echo $profile->role; ?><br><br>
            Tel No. : <?php echo $profile->telephoneNo; ?> <br><br>
            District : <?php echo $profile->district; ?> <br><br>
