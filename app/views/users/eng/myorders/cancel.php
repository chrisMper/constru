...
<div class="table1">
    <table>
        <tr>
            <td></td>
            <td colspan="2"><font color="red">This order has been cancelled by you</font></td>
        </tr>
        </table>
        <table>
        <tr height="40px">
            <td rowspan="4" width="200px"><center><img src="../../../public/img/cons.jpg" height="130px" width="150px"></center></td>
        ...
        <tr height="20px">
            ...
            <td rowspan="2" width="200px">
                <div><center><button>Completed</button></center></div>
                <div><center><button >Cancel</button></center></div>
    ...
    <table>
        ...
        <tr height="30px">
            ...
            <td rowspan="2" width="200px" >
                <div class="tbtn">
                <div><center><button>Completed</button></center></div>
                <div><center><button onclick="openForm()">Cancel</button></center></div>
            </div>
