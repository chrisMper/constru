...
<body>
    ...
    <main>
        <div class="container">
            ...
            <form id="addform" action="<?php echo URLROOT; ?>/cv/addCvData" method="POST" enctype="multipart/form-data">
                ...
                <div class="add">
                    ...
                    <p><input id="jobTitle" type="text" name="jobTitle" placeholder="Enter job title here ex: 'Civil engineer'"></p>
        ...
        <script src="<?php echo URLROOT; ?>/js/addStagesToCv.js"></script>
