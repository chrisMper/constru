...
<div class="split right">
    <form action="<?php echo URLROOT; ?>/users/engRegister" method="POST" class="form">
        ...
        <div class="form-step">
            ...
            <div class="input-group">
                ...
                <input type="text" name="Postcode" id="position" />
            </div>
            <div class="input-group">
                <label for="position">City</label>
                <input type="text" name="city" id="position" />
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                ...
                <input type="text" name="Country" id="position" />
            </div>
        ...
        <div class="form-step">
            ...
            <div class="input-group">
                <label for="ID">Upload Acedamic Trasceript</label>
                <input type="file" name="acedamicTrasceript" id="ID" />
            </div>
            <div class="btns-group">
                <a href="#" class="btn btn-prev">Previous</a>
                <a href="#" class="btn btn-next">Next</a>
