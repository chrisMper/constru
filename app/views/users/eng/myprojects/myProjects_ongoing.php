      ...
      <div class="registerbox">
        ...
        <div class="listing">
          ...
          <?php foreach ($data['engineerProjectOngoing'] as $engineerProjectOngoing) :
            if ($engineerProjectOngoing->engeneerEmail == $_SESSION['user_email']) : ?>
              <form method="post">
                ...
                <input type="text" value="<?php echo $engineerProjectOngoing->projectId ?>" hidden>
                <table>
                    ...
                    <div class='listing-card'>
                      ...
                      endforeach; ?>
                        ...
                        <?php foreach ($data['serviceProvider'] as $serviceProvider) :
                          if ($serviceProvider->email == $engineerProjectOngoing->customerEmail) : ?>

                            <h5>Customer Name : <?php echo $serviceProvider->fName;
                                                echo $serviceProvider->lName ?></h5>
                        <?php endif;
                        endforeach; ?>
          ...
          <div id="complete" class="popUp">
            ...
            <form class="acceptContent" action="<?php echo URLROOT; ?>/engBookings/engProjectStagConformation" method="POST">
